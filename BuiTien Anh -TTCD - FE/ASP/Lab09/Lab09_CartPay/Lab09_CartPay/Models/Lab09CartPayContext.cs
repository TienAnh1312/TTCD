...
public partial class Lab09CartPayContext : DbContext
{
    public Lab09CartPayContext()
    {
    }

    public Lab09CartPayContext(DbContextOptions<Lab09CartPayContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-53K42V9;Database=Lab09_CartPay;uid=sa;pwd=123456;MultipleActiveResultSets=True; TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__ADMIN_LO__4364C882347328F1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC27F1DF282A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SLIDES__3214EC27FF04E166");
